    ...
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vAposentado')) { ?>
                <li class="bg_ls"> <a href="<?php echo base_url() ?>index.php/aposentados"> <i class="icon-user"></i> Aposentados</a> </li>
            <?php } ?>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12">
                        <ul class="site-stats">
                            <li class="bg_lh"><i class="icon-group"></i> <strong><?php echo $this->db->count_all('aposentados'); ?></strong> <small>Aposentados</small></li>
