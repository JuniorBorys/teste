                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input name="vAposentado" class="marcar" type="checkbox" checked="checked" value="1" />
                                        ...
                                        <td>
                                            <label>
                                                <input name="aAposentado" class="marcar" type="checkbox" value="1" />
                                        ...
                                        <td>
                                            <label>
                                                <input name="eAposentado" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Editar Aposentado</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="dAposentado" class="marcar" type="checkbox" value="1" />
