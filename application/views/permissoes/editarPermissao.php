                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['vAposentado'])) {
                                if ($permissoes['vAposentado'] == '1') {
                                    echo 'checked';
                                }
                            } ?> name="vAposentado" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Visualizar Aposentado</span>
                                            </label>
                                        </td>

                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['aAposentado'])) {
                                if ($permissoes['aAposentado'] == '1') {
                                    echo 'checked';
                                }
                            } ?> name="aAposentado" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Adicionar Aposentado</span>
                                            </label>
                                        </td>

                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['eAposentado'])) {
                                if ($permissoes['eAposentado'] == '1') {
                                    echo 'checked';
                                }
                            } ?> name="eAposentado" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Editar Aposentado</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['dAposentado'])) {
                                if ($permissoes['dAposentado'] == '1') {
                                    echo 'checked';
                                }
                            } ?> name="dAposentado" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Excluir Aposentado</span>
                                            </label>
                                        </td>
