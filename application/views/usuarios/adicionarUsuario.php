            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="telefone" type="text" name="telefone" onKeyPress="MascaraTelefone(form1.telefone);"
                                   maxlength="14"  onBlur="ValidaTelefone(form1.telefone);" value="<?php echo set_value('telefone'); ?>"  />
                        </div>
                    </div>
