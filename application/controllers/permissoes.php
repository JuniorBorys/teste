...
class Permissoes extends CI_Controller {
    ...
    function adicionar() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $permissoes = array(
                'aAposentado' => $this->input->post('aAposentado'),
                'eAposentado' => $this->input->post('eAposentado'),
                'dAposentado' => $this->input->post('dAposentado'),
                'vAposentado' => $this->input->post('vAposentado'),
